<template>
  <div class="admin-games">
    ...
    <div class="search-bar">
      <input v-model="searchQuery" type="text" placeholder="Поиск по играм" class="input search-input" />
    ...
    <div class="games-table-wrapper">
      <table class="games-table">
        ...
        <tbody>
        <tr v-for="game in filteredGames" :key="game.id" @click="goToGameTeams(game.id)" class="game-row">
